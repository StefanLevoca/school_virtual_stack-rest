...
import paz1c_projekt.school_virtual_stack.entity.Permissions;
import paz1c_projekt.school_virtual_stack.perzistentna.DAOFactory;
import paz1c_projekt.school_virtual_stack.perzistentna.PermissionDAO;
...
public class PermissionsController {
	...
	public void addPermission(@PathVariable long id, @RequestBody String permission) throws DaoException {
		try {
			permissionDAO.addPermission(id, permission);
		} catch (Exception e) {
	...
	public Permissions getPermissionByUserId(@PathVariable long id) {
		Permissions permission = permissionDAO.getPermissionByUserId(id);
		if (permission == null) {
