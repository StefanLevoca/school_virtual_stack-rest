...
import paz1c_projekt.school_virtual_stack.entity.Device;
import paz1c_projekt.school_virtual_stack.perzistentna.DAOFactory;
import paz1c_projekt.school_virtual_stack.perzistentna.DeviceDAO;
...
public class DeviceController {
	...
	public Device addDevice(@RequestBody Device device) throws DaoException {
		try {
	...
	public void saveDevice(@RequestBody Device device) throws DaoException {
		try {
